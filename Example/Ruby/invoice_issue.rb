require 'ecpay_invoice'
		...
		inv_issue_dict = {
			"RelateNumber"=>"546465ssdasd", # 請帶30碼uid, ex: werntfg9os48trhw34etrwerh8ew2r
			...
			"SalesAmount"=>"25900", # 發票金額
			"InvoiceRemark"=>"", # 備註
			"ItemName"=>"TEST|TEST|TEST|TEST|TEST|TEST|TEST", # 商品名稱，如果超過一樣商品時請以｜(為半形不可使用全形)分隔
			"ItemCount"=>"1|1|1|1|1|1|1", # 商品數量，如果超過一樣商品時請以｜(為半形不可使用全形)分隔
			"ItemWord"=>"pic|pic|pic|pic|pic|pic|pic", # 商品單位，如果超過一樣商品時請以｜(為半形不可使用全形)分隔
			"ItemPrice"=>"3180|3180|3180|4880|4880|3600|3000", # 商品價格，如果超過一樣商品時請以｜(為半形不可使用全形)分隔
			"ItemTaxType"=>"", # 商品課稅別，如果超過一樣商品時請以｜(為半形不可使用全形)分隔，如果TaxType為9請帶值，其餘為空
			"ItemAmount"=>"3180|3180|3180|4880|4880|3600|3000", # 商品合計，如果超過一樣商品時請以｜(為半形不可使用全形)分隔
			"ItemRemark"=>"備註|備註|備註|備註|備註|備註|備註", # 商品備註，如果超過一樣商品時請以｜(為半形不可使用全形)分隔
